...
if [[ ! -f "${STIL}" ]]; then
   #first it worked without the option, but as I tested it today (27.9.) 
   #again, there was an error with the verification of the certificate,
   #so I added the '--no-check-certificate' option. Then it worked well.
